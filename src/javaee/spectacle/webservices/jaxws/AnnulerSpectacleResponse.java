...
@XmlRootElement(name = "annulerSpectacleResponse",
    namespace = "http://webservices.spectacle.javaee/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "annulerSpectacleResponse", namespace = "http://webservices.spectacle.javaee/")

public class AnnulerSpectacleResponse {
